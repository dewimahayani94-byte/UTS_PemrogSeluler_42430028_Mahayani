# UTS Pemrograman Seluler

## Identitas Mahasiswa
- **Nama Lengkap:** Ni Komang Dewi Mahayani
- **NIM:** 42430028
...
| :---: | :---: |
| ![Login Portrait](isi_link_foto_disini) | ![Login Landscape](isi_link_foto_disini) |

### 2. Halaman Panel Generator
| Input Data | Hasil Generate (If-Else & Loop) |
| :---: | :---: |
| ![Panel Input](isi_link_foto_disini) | ![Panel Output](isi_link_foto_disini) |